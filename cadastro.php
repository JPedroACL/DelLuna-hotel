  ...
  <div class="container">
   <center>
      ...
      <form action="menu.php" method="POST" >
         ...
         <label> Nome:</label> <br>
          <input type="text" class="form-control" name="nome" placeholder="Nome do Cliente" required > <i
            class="bi bi-person-fill"></i><br>
          ...
          Telefone: <input type="tel" class="form-control"
          placeholder="(00) 0 0000-0000" maxlength="11" id="phone"
          oninput="mascaratel('tele')" inputmode="numeric" name="telefone" required> 
          <br>
